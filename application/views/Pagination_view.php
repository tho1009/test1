                    ...
                    <div class="form-group">
                        <div class="col-md-6">
                            <input class="form-control" id="book_name" name="book_name"
                                   ...
                                   type="text" value="<?php echo set_value('book_name'); ?>" />
                        </div>
                        <div class="col-md-6">
                        ...
                        <tbody>
                            <?php for ($i = 0; $i <count($booklist);$i++) { ?>
                                <tr>
                                    ...
                                    <td><img src="<?php echo base_url($booklist[$i]->image); ?>" width="70px" height="100px" ></td>
                                    <td><a href="<?php echo base_url(); ?>index.php/detail">Details</a></td>
                                </tr>
                            <?php } ?>
                        </tbody>
                    </table>
